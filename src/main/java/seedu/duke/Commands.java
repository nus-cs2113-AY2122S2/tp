...
public class Commands {
    ...
    public static void viewGood(String id, ArrayList<Good> userGoods) {
        try {
    ...
    public static void listGoods(ArrayList<Good> userGoods) {
    ...
    public static void totalGoods(ArrayList<Good> userGoods) throws NullException {
        if (userGoods == null) {
