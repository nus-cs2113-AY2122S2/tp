...
public class TimetableTest {
    ...
    void showTodaySchedule_fourNonRepeatingInputsNoTimeClashNoByDate_expectSuccess() {
        ...
        dummyList.add(new Task(1,"A significantly long task description",
                null, LocalDateTime.parse("26/3/2022 09:00", inputWithTimeFormat),
                LocalDateTime.parse("26/3/2022 10:00", inputWithTimeFormat), null, 1));
        dummyList.add(new Task(2, "A somewhat long description",
                null, LocalDateTime.parse("26/3/2022 10:00", inputWithTimeFormat),
                LocalDateTime.parse("26/3/2022 11:00", inputWithTimeFormat),
                null, 2));
        dummyList.add(new Task(3, "break time!",
                null, LocalDateTime.parse("26/3/2022 11:00", inputWithTimeFormat),
                LocalDateTime.parse("26/3/2022 13:00", inputWithTimeFormat),
                null, 3));
        dummyList.add(new Task(4,"One more task to add",
                null, LocalDateTime.parse("26/3/2022 13:00", inputWithTimeFormat),
                LocalDateTime.parse("26/3/2022 15:00", inputWithTimeFormat),
                null, 4));
        Ui ui = new Ui();
