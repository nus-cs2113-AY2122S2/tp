...
public class SearchCommandTest {
    ...
    public void execute_givenDoesNotExist_matchNone() {
        ...
        testPaperNameCommand.execute(ItemListStubs.SEARCH_LIST, uiStub);
        assertEquals(ItemListStubs.SEARCH_RESULT_NONE, testPaperNameCommand.getResults());
    }
    ...
    public void execute_givenExists_matchGivenOnly() {
        ...
        testPaperNameCommand.execute(ItemListStubs.SEARCH_LIST, uiStub);
        assertEquals(ItemListStubs.SEARCH_RESULT_PAPER_NAME, testPaperNameCommand.getResults());
        ...
        testPaperNameAndDescriptionCommand.execute(ItemListStubs.SEARCH_LIST, uiStub);
        assertEquals(ItemListStubs.SEARCH_RESULT_PAPER_NAME_A4_DESCRIPTION,
        ...
        SearchCommand testDrawDescriptionCommand = new SearchCommand(Optional.empty(),
                Optional.of("draw"));
        testDrawDescriptionCommand.execute(ItemListStubs.SEARCH_LIST, uiStub);
        assertEquals(ItemListStubs.SEARCH_RESULT_DRAW_DESCRIPTION,testDrawDescriptionCommand.getResults());
    }
}
