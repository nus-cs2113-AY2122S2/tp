...
public class ItemStubs {
    ...
    public static final int PAPER_QUANTITY = 10;
    ...
    public static final Item ITEM_PAPER_A4 = generateItem(PAPER_NAME, PAPER_QUANTITY, A4_PAPER_DESCRIPTION);
    public static final Item ITEM_PAPER_A5 = generateItem(PAPER_NAME, PAPER_QUANTITY, A5_PAPER_DESCRIPTION);
