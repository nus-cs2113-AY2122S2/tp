...
class WarehouseTest {
    ...
    void addGoods() {
        ...
        /*
        //test 3, adding non-unique id with different name - fail, good is not added
        Commands.addGood("1", "tables", "15", goodsArrayList);
        assertEquals(1, goodsArrayList.size());
        */


        //test 4, blank inputs - fail, good is not added
        try {
        ...
        //test 5, empty inputs - fail, good is not added
        try {
        ...
        //test 6, non-numerical inputs for id - fail, good is not added
        try {
