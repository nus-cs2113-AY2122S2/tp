...
public class RemoveParserTest {
    ...
    @Test
    public void removeUnitGood_addAndRemoveUG_notNull() throws MissingFlagException, EmptyFieldException, WrongCommandException, InvalidFileException, InvalidObjectType {
