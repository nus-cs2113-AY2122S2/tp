...
| Group    | A group represents one or more individuals.                                                                                                       |                                                                                                                                                                |
...
| Profile  | A Profile is responsible for all data management and accesses within the lifetime of the application.                                             |
