...
13. `ActivityEditCommand#updateDummyActivityIdsInActivityCosts` is called on the session to update all dummy activityIds added by `ActivityEditCommand#addAllActivityCost` to
