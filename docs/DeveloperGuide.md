...
| Parser   | A Parser is responsible for making sense of the user inputs and processing them as Commands for the application to run the actual command.                                                                                                                                                                  |
| Command  | A Command is an object run to perform the action that the user has inputted.                                                                                                                                                                                                                                |
...
| API      | An API, short for Application Programming Interface, refers to a file that contains the source code.                                                                                                                                                                                                        |
