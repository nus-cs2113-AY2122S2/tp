...
**_Note: When editing tasks, at least one optional [parameter](#glossary) must be provided._**
...
**(Caution: You will lose all previously saved tasks if you choose the latter!)**
